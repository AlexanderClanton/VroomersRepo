...
export default function Social() {
  ...
  React.useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        setUsers(filterUsers(userData, friends));
      } catch (error) {
  ...
  const filteredUsers = searchQuery ? users.filter(user => user.username && user.username.toLowerCase().includes(searchQuery.toLowerCase())) : users;
